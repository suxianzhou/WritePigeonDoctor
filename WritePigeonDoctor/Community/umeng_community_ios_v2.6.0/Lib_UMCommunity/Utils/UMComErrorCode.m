...
NSInteger  const  ERR_CODE_Topic_Secret = 30014;
...
NSString * const  ERR_MSG_TOPIC_SECRET = @"the topic is secret to this user";
//
//===spammer===
...
//error urlpath
NSInteger  const  ERR_CODE_NULL_URLPATH = 121213;//空url
NSString * const  ERR_MSG_NULL_URLPATH = @"urlpath is invalid ";
