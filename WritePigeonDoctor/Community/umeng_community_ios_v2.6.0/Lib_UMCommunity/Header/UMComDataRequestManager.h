...
//
//typedef void(^UMComRequestCompletion)(NSDictionary *dict, NSString *urlString, NSError *error);
...
//获取下一页请求
- (void)fecthNextPageWithNextPageUrl:(NSString *)urlString
...
//获取keywords相关的用户列表
- (void)fecthUsersFromSearchWithKeywords:(NSString *)keywords
                                   count:(NSInteger)count
                              completion:(UMComRequestCompletion)completion;

//获取某个话题相关的活跃用户列表
- (void)fecthUsersWithActiveTopicId:(NSString *)topicId
                              count:(NSInteger)count
                         completion:(UMComRequestCompletion)completion;

//获取推荐的用户列表
- (void)fecthUsersRecommentWithCount:(NSInteger)count
                          completion:(UMComRequestCompletion)completion;

//获取某个用户的粉丝列表
- (void)fecthUserFansWithUid:(NSString *)uid
                       count:(NSInteger)count
                  completion:(UMComRequestCompletion)completion;
...
//获取某个用户关注的人的列表
- (void)fecthUserNearbyWithLocation:(CLLocation *)location
                              count:(NSInteger)count
                         completion:(UMComRequestCompletion)completion;
 ...
 */
- (void)fecthRealTimeHotFeedsWithCount:(NSInteger)count
                            completion:(UMComRequestCompletion)completion;

/**
 获取我关注的Feed列表
 */
- (void)fecthFeedsByFollowWithCount:(NSInteger)count
                         completion:(UMComRequestCompletion)completion;

/**
 获取推荐Feed列表
 */
- (void)fecthFeedsRecommentWithCount:(NSInteger)count
                          completion:(UMComRequestCompletion)completion;

//获取最新的Feed列表
- (void)fecthFeedsRealTimeWithCount:(NSInteger)count
                         completion:(UMComRequestCompletion)completion;
/**
 获取社区下的热门Feed列表
 */
- (void)fecthFeedsHotestWithDays:(NSInteger)days
                           count:(NSInteger)count
                      completion:(UMComRequestCompletion)completion;
...
/**
 获取好友的Feed列表
 */
- (void)fecthFeedsFriendsWithCount:(NSInteger)count
                        completion:(UMComRequestCompletion)completion;
 ...
 */
- (void)fecthFeedsTopWithCount:(NSInteger)count
                    completion:(UMComRequestCompletion)completion;
 ...
 *  @param completion     返回的block处理
 */
- (void)fecthFeedsTopicTopWithTopicID:(NSString*)topicID
                                count:(NSInteger)count
                           completion:(UMComRequestCompletion)completion;
...
获取keywords相关的Feed列表
 */
- (void)fecthFeedsSearchWithKeywords:(NSString *)keywords
                               count:(NSInteger)count
                          completion:(UMComRequestCompletion)completion;

//获取附近的Feed列表
- (void)fecthFeedsNearbyWithLocation:(CLLocation *)location
                               count:(NSInteger)count
                          completion:(UMComRequestCompletion)completion;

//获取对应feedIds列表对应的Feed列表
- (void)fecthFeedsWithFeedIds:(NSArray *)feedIds
                   completion:(UMComRequestCompletion)completion;


//获取用户时间轴的Feed列表
- (void)fecthFeedsTimelineWithUid:(NSString *)uid
                         sortType:(UMComTimeLineFeedListType)sortType
                            count:(NSInteger)count
                       completion:(UMComRequestCompletion)completion;

//获取用户被@的Feed列表
- (void)fecthFeedsUserBeAtWithCount:(NSInteger)count
                         completion:(UMComRequestCompletion)completion;

//获取用户收藏的Feed列表
- (void)fecthFeedsUserFavouriteWithCount:(NSInteger)count
                              completion:(UMComRequestCompletion)completion;

//获取话题相关的Feed列表
- (void)fecthFeedsTopicRelatedWithTopicId:(NSString *)topicId
...
//获取话题下的热门Feed列表
- (void)fecthFeedsTopicHotWithDays:(NSInteger)days
                           topicId:(NSString *)topicId
                             count:(NSInteger)count
                        completion:(UMComRequestCompletion)completion;

//获取该话题下推荐feed列表
- (void)fecthFeedsTopicRecommendWithTopicId:(NSString *)topicId
                                      count:(NSInteger)count
                                 completion:(UMComRequestCompletion)completion;

//获取单个
- (void)fecthFeedWithFeedId:(NSString *)feedId
...
//获取所有的话题列表
- (void)fecthTopicsAllWithCount:(NSInteger)count
                     completion:(UMComRequestCompletion)completion;

//获取keywords相关的话题列表
- (void)fecthTopicsSearchWithKeywords:(NSString *)keywords
                                Count:(NSInteger)count
                           completion:(UMComRequestCompletion)completion;
//获取某个用户关注的话题列表
- (void)fecthTopicsUserFocusWithUid:(NSString *)uid
                              count:(NSInteger)count
                         completion:(UMComRequestCompletion)completion;

//获取推荐话题列表
- (void)fecthTopicsRecommendWithCount:(NSInteger)count
                           completion:(UMComRequestCompletion)completion;

//获取单个话题
- (void)fecthTopicWithTopicId:(NSString *)topicId
                   completion:(UMComRequestCompletion)completion;

//获取话题组列表
- (void)fecthTopicGroupdsWithCount:(NSInteger)count
                        completion:(UMComRequestCompletion)completion;
//获取组下的话题列表
- (void)fecthTopicsWithTopicGroupID:(NSString *)groupID
                              count:(NSInteger)count
                         completion:(UMComRequestCompletion)completion;
...
//获取某个Feed的评论列表
- (void)fecthCommentsWithFeedId:(NSString *)feedId
...
//获取用户收到的评论列表
- (void)fecthCommentsUserReceivedWithCount:(NSInteger)count
                                completion:(UMComRequestCompletion)completion;

//获取用户写过的评论列表
- (void)fecthCommentsUserSentWithCount:(NSInteger)count
                            completion:(UMComRequestCompletion)completion;
...
#pragma mark - like
//获取某个Feed的点赞列表
- (void)fecthLikesFeedWithFeedId:(NSString *)feedId
                           count:(NSInteger)count
                      completion:(UMComRequestCompletion)completion;
//获取用户点赞列表
- (void)fecthLikesUserReceivedWithCount:(NSInteger)count
                             completion:(UMComRequestCompletion)completion;

//获取用户点赞记录
- (void)fecthLikesUserSendsWithCount:(NSInteger)count
                          completion:(UMComRequestCompletion)completion;

#pragma mark - notification

//获取用户通知列表
- (void)fecthMyNotificationWithCount:(NSInteger)count
                            completion:(UMComRequestCompletion)completion;


#pragma mark - album
//获取用户相册列表
- (void)fecthAlbumWithUid:(NSString *)uid
                    count:(NSInteger)count
               completion:(UMComRequestCompletion)completion;

#pragma mark - Private Letter
//获取私信列表
- (void)fecthPrivateLetterWithCount:(NSInteger)count
                         completion:(UMComRequestCompletion)completion;

//获取私信聊天记录
- (void)fecthPrivateChartRecordWithUid:(NSString *)toUid
                     private_letter_id:(NSString *)private_letter_id
                                 count:(NSInteger)count
                            completion:(UMComRequestCompletion)completion;
//初始化私信窗口
- (void)getChartBoxWithUid:(NSString *)toUId
                 responese:(UMComRequestCompletion)completion;
//发送私信
...
// 获取 地理位置数据
- (void)fecthLocationNamesWithLocation:(CLLocation *)location
                            completion:(UMComRequestCompletion)completion;
 ...
 */
- (void)fecthConfigDataWithCompletion:(UMComRequestCompletion)completion;


- (void)updateTemplateChoice:(NSUInteger)choice
                    completion:(UMComRequestCompletion)completion;

- (void)fecthCommunityStatisticsDataWithCompletion:(UMComRequestCompletion)completion;

-(void)fecthCommunityGuestWithCompletion:(UMComRequestCompletion)completion;

-(void)fecthCommunityTokenWithAppkey:(NSString *)appKey
 ...
 *
 *  @param count    申请的个数
 *  @param completion 返回的数据回调的block
 */
